...
class SymbCtrl():
  ...
  ctrlRegs= {          # mapping of all implemented Modbus registers in the SymbCtrl
    ...
    'Control1Name':    {'addr':258,'mode':'rw','type':'str',  'value':''   ,'desc':'Decription of control loop 1'},
    'Control2Name':    {'addr':266,'mode':'rw','type':'str',  'value':''   ,'desc':'Decription of control loop 2'},
    'Control3Name':    {'addr':274,'mode':'rw','type':'str',  'value':''   ,'desc':'Decription of control loop 3'},
    'Control4Name':    {'addr':282,'mode':'rw','type':'str',  'value':''   ,'desc':'Decription of control loop 4'},
    ...
    'LogicInA':        {'addr':136,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'LogicInB':        {'addr':137,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'LogicFunction':   {'addr':138,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'LogicOut':        {'addr':139,'mode':'r', 'type':'uint', 'value':0    ,'desc':''},
    'ToDStart':        {'addr':140,'mode':'r', 'type':'hour', 'value':0    ,'desc':'Formatted ToD start time string'},
    'ToDStartHour':    {'addr':140,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'ToDStartMin':     {'addr':141,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'ToDStop':         {'addr':142,'mode':'r' ,'type':'hour', 'value':0    ,'desc':'Formatted ToD stop time string'},
    'ToDStopHour':     {'addr':142,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'ToDStopMin':      {'addr':143,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'ToDOutput1':      {'addr':144,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'ToDOutput2':      {'addr':145,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'ToDOutput3':      {'addr':146,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'ToDOutput4':      {'addr':147,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'CountSource':     {'addr':150,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'Counter':         {'addr':151,'mode':'r', 'type':'dint', 'value':0    ,'desc':'Event counter'},
    'CountRstIntv':    {'addr':153,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'TimerSource':     {'addr':154,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    'Timer':           {'addr':155,'mode':'r', 'type':'dint', 'value':0    ,'desc':'Event counter in seconds'},
    'TimerRstIntv':    {'addr':157,'mode':'rw','type':'uint', 'value':0    ,'desc':''},
    ...
    'VirtualIO1':      {'addr': 18,'mode':'rw','type':'bool', 'value':False,'desc':''},
    'VirtualIO2':      {'addr': 19,'mode':'rw','type':'bool', 'value':False,'desc':''},
    'WQSensorValid':   {'addr': 20,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    'Temp1Valid':      {'addr': 21,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    'Temp2Valid':      {'addr': 22,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    'Analog1Valid':    {'addr': 23,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    'Analog2Valid':    {'addr': 24,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    'LocalTempValid':  {'addr': 25,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    'SupVoltValid':    {'addr': 26,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    'ProcReadValid':   {'addr': 27,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    'LogicGateResult': {'addr': 28,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    'Flash':           {'addr': 29,'mode':'r', 'type':'bool', 'value':False,'desc':''},
    ...
    'CounterEnable':   {'addr': 59,'mode':'rw','type':'bool', 'value':False,'desc':'Enable event counter'},
    'TimerEnable':     {'addr': 60,'mode':'rw','type':'bool', 'value':False,'desc':'Enable event timer'},
