...
class SymbCtrl():
  ...
  ctrlRegs= {          # mapping of all implemented Modbus registers in the SymbCtrl mk2
    ...
    'TimeLimCmdOut':   {'addr':148,'mode':'rw','type':'uint', 'unit':None,            'valid':None,            'desc':'Time limited command output channel'},
    'TimeLimCmdTime':  {'addr':149,'mode':'rw','type':'uint', 'unit':None,            'valid':None,            'desc':'Time limited command duration'},
